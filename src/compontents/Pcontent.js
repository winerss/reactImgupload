              ...
              <div className="wrapper">
                  ...
                  <div className="upImg">
                    ...
                    <div className="fileWrap">
                      <input className="selectImg" type="file" name="files" multiple  accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" onChange={this.upImg} />
                    </div>
                  </div>
                </div>
            </div>
